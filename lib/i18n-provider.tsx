...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "borrow.kycRequired": "Identity Verification Required",
    "borrow.kycRequiredDesc":
      "You must complete identity verification before executing a loan. Please verify your identity first.",
    "borrow.verifyIdentity": "Verify Identity",
    "borrow.kycVerified": "Identity verification completed",
    "borrow.kycRequiredButton": "Complete identity verification first",
    "trade.enterAmount": "0",
    ...
    "trade.fee": "Fee",
    "borrow.maxLoanAmount": "Max Loan Amount",
    "borrow.selectAccountWarning": "Please select at least one account to use as collateral",
    ...
    "trade.sellCompleted": "Sale completed!",
  ...
  ko: {
    ...
    "borrow.kycRequired": "본인인증이 필요합니다",
    "borrow.kycRequiredDesc": "대출을 실행하기 전 본인인증을 먼저 해야 합니다. 본인인증을 진행해주세요.",
    "borrow.verifyIdentity": "본인인증하기",
    "borrow.kycVerified": "본인인증이 완료되었습니다",
    "borrow.kycRequiredButton": "본인인증을 먼저 완료해주세요",
    "trade.enterAmount": "0",
    ...
    "trade.fee": "수수료",
    "borrow.maxLoanAmount": "최대 대출 가능",
    "borrow.selectAccountWarning": "담보로 사용할 계좌를 최소 1개 이상 선택해주세요",
    "common.shares": "주",
    ...
    "trade.sellCompleted": "판매가 완료되었습니다!",
